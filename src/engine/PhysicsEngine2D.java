...
public class PhysicsEngine2D {
    ...
    public PhysicsEngine2D(){
        ...
        CircularObject co = new CircularObject("Grün", new Position(100,50), .8, 0, 10, Color.GREEN);
        ...
        CircularObject co_5 = new CircularObject("Orange", new Position(600,550), 0, -1.8, 10, Color.ORANGE);
